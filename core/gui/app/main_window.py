...
class LuminaMainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.header_layout.setContentsMargins(18, 2, 18, 2)
        self.header_layout.setSpacing(8)
        title_label = QLabel("Lumina")
        title_label.setObjectName("mainWindowTitle")
        self.header_layout.addWidget(title_label)

        self.workspace_tabs = QTabBar()
        self.workspace_tabs.setObjectName("topNavTabs")
        ...
        self.header_layout.addWidget(self.workspace_tabs)
        self.header_layout.addStretch(1)
        root.addWidget(header_frame, stretch=0)

        self.page_stack = QStackedWidget()
        page_container = QWidget()
        page_container.setObjectName("mainWindowPageContainer")
